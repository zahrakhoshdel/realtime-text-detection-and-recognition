...
def decode_predictions(scores, geometry):
	...
	for y in range(0, numRows):
		...
		for x in range(0, numCols):
			# مناطقي که حدقل احتمال را براي وجود متن ندارند بررسي نميکنيم
			...
			# زاويه چرخش بري پيش بيني استخراج مي شود
			...
			# مختصات کادر محدوده منظقه متن و احتمال آن به روز يا اپديت مي شود
...
# براي تشخيص متن با استفاده از مدل يادگيري عميق استفاده شده به خروجي ويژگي هاي دو لايه اط شبکه عصبي نياز داريم
...
while True:
	...
	for (startX, startY, endX, endY) in boxes:
		# مختصات کادر محدوه منطقه متن را بر  اساس نسبت هاي مربوطه به دست مي اورد
	...
	# براي خروج دستي از حلقه مي توانيم کليد کيو را فشار دهيم
	if key == ord("q"):
		break
